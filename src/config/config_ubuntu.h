...
#define DUNE_GEOMETRY_VERSION "2.3.1"
...
#define DUNE_ISTL_VERSION "2.3.1"
...
#define DUNE_LOCALFUNCTIONS_VERSION "2.3.1"
...
#define SYSTEM_ENDIAN_HEADER <endian.h>
...
#define XDR_UINT64_FUNC xdr_uint64_t
