/*! \file brusselator_algo.h
    ...
    \brief Numerical experiment for the solution driven paper
     ...
     \f{equation*}{
       f_1(u,w) = \gamma (a - u + u^2 w) \quad \land \quad f_2(u,w) = \gamma (b - u^2 w),
     \f}
     and for the surface 
     \f{align*}{
...
namespace Esfem{
  ...
  public:
    ...
    /*!< \brief The constructor that also performs the first part before the loop enters
    ...
    //@{
    void next_timeStep(); 
    /*!< \brief Increments the next time step for `time_provider`.  Use this in every for-loop.
     */
