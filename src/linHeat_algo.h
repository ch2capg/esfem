/*! \file linHeat_algo.h
    ...
    \brief <Program Name>
     ...
     Standard routine for an linear parabolic esfem on a stationary surface.
     For a new experiment you have to modify:
      - io_parameter.cpp
      - secOrd_op_rhs.cpp
      - secOrd_op_initData.cpp
     If you indent to use a new parabolic operator, then you have to create 
     a new secOrd_op_XXX.{h.cpp} file and include it in secOrd_op.h.
